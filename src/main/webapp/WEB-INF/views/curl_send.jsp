...
<%
	try{
		...
		sms.put("receiver", "01046624797"); // 수신번호
		sms.put("destination", "01046624797|담당자"); // 수신인 %고객명% 치환
		sms.put("sender", "01046624797"); // 발신번호
		//sms.put("rdate", "20250226"); // 예약일자 - 20161004 : 2016-10-04일기준
		//sms.put("rtime", "1550"); // 예약시간 - 1930 : 오후 7시30분
		sms.remove("rdate");
		sms.remove("rtime");
